...
import (
	...
	"fiber-jwt-starter/internal/repository/psql"
	"fiber-jwt-starter/internal/routes"
	"fiber-jwt-starter/middleware"
	dbconfig "fiber-jwt-starter/pkg/db"
	"fiber-jwt-starter/pkg/logging"
	"fiber-jwt-starter/pkg/validator"
